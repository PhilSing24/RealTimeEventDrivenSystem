 ...
 *   - WebSocket connection management (TLS)
 ...
 *   - IPC publication to tickerplant
 * 
 * Design decisions:
 ...
 * and publishes them to the tickerplant. Runs indefinitely until interrupted.
 * 
 * @return 0 on clean exit, 1 on connection failure
 */
